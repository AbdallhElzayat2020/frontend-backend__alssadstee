    ...
    <section class="about-page-header">
        ...
        <div class="container">
            <div class="about-header-content">
                <h1 class="about-page-title">{{ __('contact-us.title') }}</h1>
            </div>
        </div>
    </section>
    ...
    <section id="contact" class="contact-section py-5">
        <div class="container">
            <div class="row g-4">
                <!-- Contact Information -->
                <div class="col-lg-4">
                    <div class="contact-info-card p-4 rounded-4 shadow-lg h-100">
                        ...
                        <div class="contact-item mb-4">
                            ...
                            <div class="contact-details">
                                ...
                                <p class="contact-value mb-0">
                                    Saudi Arabia | Riyadh | 2nd Industrial City
                                </p>
                            </div>
                        </div>
                ...
                <div class="col-lg-8">
                    <!-- Contact Form -->
                    <div class="contact-form-card p-4 p-lg-5 rounded-4 shadow-lg mb-4">
