<head>
    @php
        ...
        $resolvedTitle = !empty($seoMeta['title']) ? $seoMeta['title'] : trim($__env->yieldContent('title'));
        $schemaDecoded = !empty($seoMeta['schema_json_ld']) ? json_decode($seoMeta['schema_json_ld'], true) : null;
    @endphp
    <meta charset="UTF-8" />
    ...
    <head>
        ...
        <script>
            ...
            })(window, document, 'script', 'dataLayer', 'GTM-NP9RQLL9');
        </script>
